...
#define ub1 ub1x.it_b
	...
	RTCC(arg1, 982, l_feature_name, 1, eif_new_type(233, 0x01), 0x01);
	RTCC(arg2, 982, l_feature_name, 2, eif_new_type(981, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("a_key_attached", EX_PRE);
...
body:;
	...
	if (EIF_TEST(loc1)) {
		...
		ur1 = RTCCL(tr2);
		ub1 = (EIF_BOOLEAN) 0;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(5235, "assert", arg2))(arg2, ur1x, ub1x);
		RTHOOK(6);
		RTDBGAL(0, 0xF80000F4, 0,0); /* Result */
