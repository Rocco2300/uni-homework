...
extern EIF_TYPED_VALUE F126_1888(EIF_REFERENCE);
...
RTOID (F126_1888)
EIF_TYPED_VALUE F126_1888 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 125, Current, 0, 0, 1849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(125, Current, 1849);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
