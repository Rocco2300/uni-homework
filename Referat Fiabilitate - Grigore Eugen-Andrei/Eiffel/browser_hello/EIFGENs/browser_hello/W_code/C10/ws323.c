...
extern EIF_TYPED_VALUE F323_6557(EIF_REFERENCE);
...
EIF_TYPED_VALUE F323_6557 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 322, Current, 1, 0, 11431);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(322, Current, 11431);
	RTIV(Current, RTAL);
	RTHOOK(1);
