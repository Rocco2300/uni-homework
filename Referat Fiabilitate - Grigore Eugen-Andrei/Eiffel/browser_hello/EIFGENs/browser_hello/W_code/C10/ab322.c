...
extern EIF_TYPED_VALUE F322_6504(EIF_REFERENCE);
extern void F322_8344(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F322_6504 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 321, Current, 0, 0, 10830);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(321, Current, 10830);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F322_8344 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 321, Current, 0, 8343);
	RTSA(dtype);
	RTME(dtype, 0);
