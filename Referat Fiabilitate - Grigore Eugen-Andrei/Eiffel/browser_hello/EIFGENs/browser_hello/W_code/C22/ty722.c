...
extern EIF_TYPED_VALUE F722_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F722_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 721, Current, 0, 0, 4106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(721, Current, 4106);
	RTIV(Current, RTAL);
