...
extern EIF_TYPED_VALUE F720_4858(EIF_REFERENCE);
extern EIF_TYPED_VALUE F720_4861(EIF_REFERENCE);
extern void F720_8320(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F720_4858 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 719, Current, 0, 0, 6010);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(719, Current, 6010);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F720_4861 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 719, Current, 0, 0, 6011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(719, Current, 6011);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F720_8320 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 719, Current, 0, 8319);
	RTSA(dtype);
	RTME(dtype, 0);
