...
extern EIF_TYPED_VALUE F747_5135(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F747_5136(EIF_REFERENCE);
extern EIF_TYPED_VALUE F747_5137(EIF_REFERENCE);
extern void F747_8325(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F747_5135 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 746, Current, 2, 1, 7653);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(746, Current, 7653);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tu1_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3796, "item", arg1))(arg1)).it_n1);
...
/* {LIST}.after */
EIF_TYPED_VALUE F747_5136 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 746, Current, 0, 0, 7654);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(746, Current, 7654);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F747_5137 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 746, Current, 0, 0, 7655);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(746, Current, 7655);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3769, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F747_8325 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 746, Current, 0, 8324);
	RTSA(dtype);
	RTME(dtype, 0);
