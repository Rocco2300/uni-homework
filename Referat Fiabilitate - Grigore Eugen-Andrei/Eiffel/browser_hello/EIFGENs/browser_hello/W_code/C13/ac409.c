...
extern EIF_TYPED_VALUE F409_4380(EIF_REFERENCE);
extern void F409_8310(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F409_4380 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 408, Current, 0, 0, 5329);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(408, Current, 5329);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F409_8310 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 408, Current, 0, 8309);
	RTSA(dtype);
	RTME(dtype, 0);
