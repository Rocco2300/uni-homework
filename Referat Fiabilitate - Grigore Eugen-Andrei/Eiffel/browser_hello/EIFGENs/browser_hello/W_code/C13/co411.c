...
extern EIF_TYPED_VALUE F411_4355(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F411_4358(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F411_4360(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F411_4355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 410, Current, 0, 1, 5263);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(410, Current, 5263);
	RTCC(arg1, 410, l_feature_name, 1, RTWCT(3486, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F411_4358 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 410, Current, 1, 1, 5264);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(410, Current, 5264);
	{
...
void F411_4360 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 410, Current, 0, 1, 5265);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(410, Current, 5265);
	RTCC(arg1, 410, l_feature_name, 1, RTWCT(3486, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
