...
extern EIF_TYPED_VALUE F401_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F401_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 400, Current, 0, 0, 4100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(400, Current, 4100);
	RTIV(Current, RTAL);
