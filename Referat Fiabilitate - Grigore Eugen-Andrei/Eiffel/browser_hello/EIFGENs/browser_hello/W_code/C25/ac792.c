...
extern void F792_8310(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F792_4380 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 791, Current, 0, 0, 5343);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(791, Current, 5343);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F792_8310 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 791, Current, 0, 8309);
	RTSA(dtype);
	RTME(dtype, 0);
