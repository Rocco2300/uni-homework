...
extern void F821_5139(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F821_5141(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F821_5142(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F821_5146(EIF_REFERENCE);
...
void F821_5139 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 820, Current, 1, 1, 7709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 7709);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		RTHOOK(4);
		uu2_1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4243, dtype))(Current, uu2_1x);
	} else {
		RTHOOK(5);
		...
		if (tb1) {
			...
			RTHOOK(7);
			uu2_1 = arg1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4245, dtype))(Current, uu2_1x);
			RTHOOK(8);
...
void F821_5141 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 820, Current, 0, 1, 7710);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 7710);
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(7);
		tu2_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3796, "item", arg1))(arg1)).it_n2);
		uu2_1 = tu2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4244, dtype))(Current, uu2_1x);
		RTHOOK(8);
...
void F821_5142 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 820, Current, 0, 1, 7711);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 7711);
	RTCC(arg1, 820, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F821_5146 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 820, Current, 0, 0, 7708);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(820, Current, 7708);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3786, 821))(Current);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3777, dtype))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
