...
extern EIF_TYPED_VALUE F841_4422(EIF_REFERENCE);
extern void F841_8313(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F841_4422 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 840, Current, 0, 0, 5425);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(840, Current, 5425);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F841_8313 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 840, Current, 0, 8312);
	RTSA(dtype);
	RTME(dtype, 0);
