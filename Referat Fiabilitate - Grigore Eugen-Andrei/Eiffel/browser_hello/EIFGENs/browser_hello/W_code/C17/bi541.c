...
extern void F541_4352(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F541_8309(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F541_4349 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 540, Current, 0, 0, 5234);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(540, Current, 5234);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F541_4352 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 540, Current, 0, 1, 5235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(540, Current, 5235);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3776, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	uc1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3768, 525))(Current, uc1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F541_8309 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 540, Current, 0, 8308);
	RTSA(dtype);
	RTME(dtype, 0);
