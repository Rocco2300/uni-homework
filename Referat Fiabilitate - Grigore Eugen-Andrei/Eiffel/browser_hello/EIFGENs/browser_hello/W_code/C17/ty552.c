...
extern EIF_TYPED_VALUE F552_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F552_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 551, Current, 0, 0, 4104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(551, Current, 4104);
	RTIV(Current, RTAL);
