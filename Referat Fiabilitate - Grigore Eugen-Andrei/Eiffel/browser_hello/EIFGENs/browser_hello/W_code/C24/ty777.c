...
extern EIF_TYPED_VALUE F777_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F777_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 776, Current, 0, 0, 4107);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(776, Current, 4107);
	RTIV(Current, RTAL);
