...
extern void F81_1288(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 80, Current, 1, 0, 1307);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(80, Current, 1307);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1213, dtype))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 80, Current, 0, 0, 1308);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(80, Current, 1308);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 80, Current, 0, 0, 1309);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(80, Current, 1309);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF8000052, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(83, 0x01).id);
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 80, Current, 0, 1, 1310);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(80, Current, 1310);
