...
extern EIF_TYPED_VALUE F93_1428(EIF_REFERENCE);
extern EIF_TYPED_VALUE F93_1429(EIF_REFERENCE);
extern EIF_TYPED_VALUE F93_1430(EIF_REFERENCE);
...
EIF_TYPED_VALUE F93_1428 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F93_1429 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F93_1430 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 92, Current, 0, 0, 1423);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(92, Current, 1423);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(1277, "fractional_second", tr1));
