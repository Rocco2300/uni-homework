...
extern EIF_TYPED_VALUE F456_4858(EIF_REFERENCE);
extern EIF_TYPED_VALUE F456_4861(EIF_REFERENCE);
extern void F456_8320(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F456_4858 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 455, Current, 0, 0, 5995);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(455, Current, 5995);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F456_4861 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 455, Current, 0, 0, 5996);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(455, Current, 5996);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F456_8320 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 455, Current, 0, 8319);
	RTSA(dtype);
	RTME(dtype, 0);
