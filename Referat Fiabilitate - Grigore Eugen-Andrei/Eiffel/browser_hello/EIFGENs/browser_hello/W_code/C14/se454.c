...
extern EIF_TYPED_VALUE F454_4366(EIF_REFERENCE);
...
EIF_TYPED_VALUE F454_4366 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 453, Current, 0, 0, 5299);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(453, Current, 5299);
	RTIV(Current, RTAL);
	RTHOOK(1);
