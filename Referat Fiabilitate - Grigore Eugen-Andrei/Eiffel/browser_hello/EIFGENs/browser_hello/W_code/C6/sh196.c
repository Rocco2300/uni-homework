...
extern EIF_TYPED_VALUE F196_2481(EIF_REFERENCE);
...
RTOID (F196_2481)
EIF_TYPED_VALUE F196_2481 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 195, Current, 0, 0, 2460);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(195, Current, 2460);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
