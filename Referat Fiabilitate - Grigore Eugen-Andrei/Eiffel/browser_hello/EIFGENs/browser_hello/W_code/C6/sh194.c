...
extern EIF_TYPED_VALUE F194_2474(EIF_REFERENCE);
...
RTOID (F194_2474)
EIF_TYPED_VALUE F194_2474 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 193, Current, 0, 0, 2453);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(193, Current, 2453);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
