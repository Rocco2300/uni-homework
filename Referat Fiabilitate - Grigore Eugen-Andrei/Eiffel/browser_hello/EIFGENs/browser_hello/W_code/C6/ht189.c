...
extern void F189_2413(EIF_REFERENCE);
...
void F189_2413 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 188, Current, 2, 0, 2396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(188, Current, 2396);
	RTIV(Current, RTAL);
	if (
		WDBG(188,"dbglog")
	) {
		...
		loc2 = RTCCL(tr1);
		if (EIF_TEST(loc2)) {
			tb2 = *(EIF_BOOLEAN *)(loc2 + RTVA(3152, "descriptor_available", loc2));
			tb1 = tb2;
		}
		if (tb1) {
			RTHOOK(2);
			RTDBGAL(1, 0xF8000135, 0, 0); /* loc1 */
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2988, "descriptor", loc2))(loc2)).it_i4);
	...
	RTHOOK(5);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2136, 187))(Current);
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(608, dtype))(Current);
	if (
		WDBG(188,"dbglog")
	) {
		RTHOOK(7);
