...
extern EIF_TYPED_VALUE F580_4424(EIF_REFERENCE);
extern EIF_TYPED_VALUE F580_4425(EIF_REFERENCE);
extern EIF_TYPED_VALUE F580_4426(EIF_REFERENCE);
extern EIF_TYPED_VALUE F580_4427(EIF_REFERENCE);
extern void F580_4428(EIF_REFERENCE);
extern void F580_8314(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F580_4424 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F580_4425 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F580_4426 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 579, Current, 0, 0, 5453);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(579, Current, 5453);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F580_4427 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 579, Current, 0, 0, 5454);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(579, Current, 5454);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F580_4428 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 579, Current, 0, 0, 5455);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(579, Current, 5455);
	RTIV(Current, RTAL);
...
void F580_8314 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 579, Current, 0, 8313);
	RTSA(dtype);
	RTME(dtype, 0);
