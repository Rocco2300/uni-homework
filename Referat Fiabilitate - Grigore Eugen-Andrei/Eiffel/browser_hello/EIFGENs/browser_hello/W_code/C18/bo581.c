...
extern void F581_8313(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F581_4422 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 580, Current, 0, 0, 5415);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(580, Current, 5415);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F581_8313 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 580, Current, 0, 8312);
	RTSA(dtype);
	RTME(dtype, 0);
