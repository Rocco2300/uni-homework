...
extern EIF_TYPED_VALUE F880_4355(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F880_4358(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F880_4360(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F880_4355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 879, Current, 0, 1, 5290);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(879, Current, 5290);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F880_4358 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 879, Current, 1, 1, 5291);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(879, Current, 5291);
	{
...
void F880_4360 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 879, Current, 0, 1, 5292);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(879, Current, 5292);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
