...
extern EIF_TYPED_VALUE F862_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F862_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 861, Current, 0, 0, 4109);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(861, Current, 4109);
	RTIV(Current, RTAL);
