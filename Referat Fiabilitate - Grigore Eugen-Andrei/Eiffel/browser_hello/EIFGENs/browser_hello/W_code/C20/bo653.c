...
extern EIF_TYPED_VALUE F653_4422(EIF_REFERENCE);
extern void F653_8313(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F653_4422 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 652, Current, 0, 0, 5419);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(652, Current, 5419);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F653_8313 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 652, Current, 0, 8312);
	RTSA(dtype);
	RTME(dtype, 0);
