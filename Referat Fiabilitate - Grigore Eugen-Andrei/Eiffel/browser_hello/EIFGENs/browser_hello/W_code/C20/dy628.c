...
extern EIF_TYPED_VALUE F628_5121(EIF_REFERENCE);
extern void F628_5127(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F628_5128(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F628_5131(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F628_5132(EIF_REFERENCE);
extern EIF_TYPED_VALUE F628_5133(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F628_5121 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 627, Current, 0, 0, 7580);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(627, Current, 7580);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DYNAMIC_CHAIN}.prune */
void F628_5127 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 627, Current, 0, 1, 7581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(627, Current, 7581);
	RTIV(Current, RTAL);
...
void F628_5128 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 627, Current, 0, 1, 7582);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(627, Current, 7582);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F628_5131 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 627, Current, 3, 1, 7583);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(627, Current, 7583);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3298, "item", loc3))(loc3)).it_b);
				ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3621, "target_index", loc3))(loc3)).it_i4);
...
void F628_5132 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 627, Current, 0, 0, 7584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(627, Current, 7584);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F628_5133 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 627, Current, 2, 1, 7585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(627, Current, 7585);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
