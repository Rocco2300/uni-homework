...
extern EIF_TYPED_VALUE F474_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F474_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 473, Current, 0, 0, 4102);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(473, Current, 4102);
	RTIV(Current, RTAL);
