...
extern EIF_TYPED_VALUE F462_4420(EIF_REFERENCE);
extern void F462_8312(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F462_4420 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 461, Current, 0, 0, 5387);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(461, Current, 5387);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F462_8312 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 461, Current, 0, 8311);
	RTSA(dtype);
	RTME(dtype, 0);
