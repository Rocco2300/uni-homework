...
extern EIF_TYPED_VALUE F466_4380(EIF_REFERENCE);
extern void F466_8310(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F466_4380 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 465, Current, 0, 0, 5331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(465, Current, 5331);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F466_8310 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 465, Current, 0, 8309);
	RTSA(dtype);
	RTME(dtype, 0);
