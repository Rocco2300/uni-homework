...
extern EIF_TYPED_VALUE F472_4858(EIF_REFERENCE);
extern EIF_TYPED_VALUE F472_4861(EIF_REFERENCE);
extern void F472_8320(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F472_4858 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 471, Current, 0, 0, 5998);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(471, Current, 5998);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F472_4861 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 471, Current, 0, 0, 5999);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(471, Current, 5999);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) (ti4_1 <= ti4_2)) {
			...
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4064, dtype))(Current)).it_i4);
...
void F472_8320 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 471, Current, 0, 8319);
	RTSA(dtype);
	RTME(dtype, 0);
