...
extern EIF_TYPED_VALUE F932_4861(EIF_REFERENCE);
extern void F932_8320(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 931, Current, 0, 0, 6025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(931, Current, 6025);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F932_4861 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 931, Current, 0, 0, 6026);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(931, Current, 6026);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F932_8320 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 931, Current, 0, 8319);
	RTSA(dtype);
	RTME(dtype, 0);
