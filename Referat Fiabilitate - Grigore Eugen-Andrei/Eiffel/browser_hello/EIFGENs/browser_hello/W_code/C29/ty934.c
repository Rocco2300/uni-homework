...
extern EIF_TYPED_VALUE F934_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F934_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 933, Current, 0, 0, 4111);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(933, Current, 4111);
	RTIV(Current, RTAL);
