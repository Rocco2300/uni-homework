...
extern EIF_TYPED_VALUE F923_5136(EIF_REFERENCE);
extern EIF_TYPED_VALUE F923_5137(EIF_REFERENCE);
extern void F923_8325(EIF_REFERENCE, int);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 922, Current, 2, 1, 7669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(922, Current, 7669);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3796, "item", arg1))(arg1)).it_r4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F923_5136 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 922, Current, 0, 0, 7670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(922, Current, 7670);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F923_5137 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 922, Current, 0, 0, 7671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(922, Current, 7671);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3769, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F923_8325 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 922, Current, 0, 8324);
	RTSA(dtype);
	RTME(dtype, 0);
