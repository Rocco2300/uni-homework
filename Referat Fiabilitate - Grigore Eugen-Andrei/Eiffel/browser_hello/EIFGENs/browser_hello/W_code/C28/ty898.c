...
extern EIF_TYPED_VALUE F898_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F898_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 897, Current, 0, 0, 4110);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 4110);
	RTIV(Current, RTAL);
