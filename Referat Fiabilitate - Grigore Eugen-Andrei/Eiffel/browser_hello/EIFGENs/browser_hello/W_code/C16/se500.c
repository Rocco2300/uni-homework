...
extern EIF_TYPED_VALUE F500_4475(EIF_REFERENCE);
extern EIF_TYPED_VALUE F500_4476(EIF_REFERENCE);
extern void F500_4477(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F500_4478(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F500_4479(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F500_4480(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F500_4481(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SEQUENCE}.readable */
EIF_TYPED_VALUE F500_4475 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 499, Current, 0, 0, 5553);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(499, Current, 5553);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SEQUENCE}.writable */
EIF_TYPED_VALUE F500_4476 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 499, Current, 0, 0, 5554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(499, Current, 5554);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3761, dtype))(Current)).it_b);
...
/* {SEQUENCE}.force */
void F500_4477 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 499, Current, 0, 1, 5555);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(499, Current, 5555);
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F500_4478 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 499, Current, 1, 1, 5556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(499, Current, 5556);
	{
...
/* {SEQUENCE}.put */
void F500_4479 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 499, Current, 0, 1, 5557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(499, Current, 5557);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {SEQUENCE}.prune */
void F500_4480 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 499, Current, 0, 1, 5558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(499, Current, 5558);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune_all */
void F500_4481 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 499, Current, 0, 1, 5559);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(499, Current, 5559);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
