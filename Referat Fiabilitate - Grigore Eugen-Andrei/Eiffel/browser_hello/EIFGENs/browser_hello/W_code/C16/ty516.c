...
extern EIF_TYPED_VALUE F516_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F516_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 515, Current, 0, 0, 4103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(515, Current, 4103);
	RTIV(Current, RTAL);
