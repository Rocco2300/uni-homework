...
extern EIF_TYPED_VALUE F524_4420(EIF_REFERENCE);
extern void F524_8312(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F524_4420 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 523, Current, 0, 0, 5391);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(523, Current, 5391);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F524_8312 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 523, Current, 0, 8311);
	RTSA(dtype);
	RTME(dtype, 0);
