...
extern EIF_TYPED_VALUE F523_4422(EIF_REFERENCE);
extern void F523_8313(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F523_4422 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 522, Current, 0, 0, 5413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(522, Current, 5413);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F523_8313 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 522, Current, 0, 8312);
	RTSA(dtype);
	RTME(dtype, 0);
