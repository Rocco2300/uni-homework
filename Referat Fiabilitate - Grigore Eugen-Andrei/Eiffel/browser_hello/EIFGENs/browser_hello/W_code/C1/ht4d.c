...
static const EIF_TYPE_INDEX egt_0_4 [] = {0xFF01,309,0xFFFF};
static const EIF_TYPE_INDEX egt_1_4 [] = {0xFF01,395,3,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_4 [] = {0xFF01,309,0xFFFF};
static const EIF_TYPE_INDEX egt_10_4 [] = {0xFF01,309,0xFFFF};
...
static const struct desc_info desc_4[] = {
	...
	{EIF_NON_GENERIC(0x0251 /*296*/), 59, 0},
};
void Init4(void)
{
	IDSC(desc_4, 0, 3);
	IDSC(desc_4 + 1, 2, 3);
	IDSC(desc_4 + 32, 385, 3);
}
