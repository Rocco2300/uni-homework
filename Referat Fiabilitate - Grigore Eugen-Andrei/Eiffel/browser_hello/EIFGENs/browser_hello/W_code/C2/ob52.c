...
extern EIF_TYPED_VALUE F52_833(EIF_REFERENCE);
...
EIF_TYPED_VALUE F52_833 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 51, Current, 0, 0, 892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(51, Current, 892);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80002F6, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,758,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
