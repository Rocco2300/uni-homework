...
extern EIF_TYPED_VALUE F959_5135(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F959_5136(EIF_REFERENCE);
extern EIF_TYPED_VALUE F959_5137(EIF_REFERENCE);
extern void F959_8325(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F959_5135 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 958, Current, 2, 1, 7673);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(958, Current, 7673);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tr8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3796, "item", arg1))(arg1)).it_r8);
...
/* {LIST}.after */
EIF_TYPED_VALUE F959_5136 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 7674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(958, Current, 7674);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F959_5137 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 958, Current, 0, 0, 7675);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(958, Current, 7675);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3769, dtype))(Current)).it_i4);
...
/* {LIST}._invariant */
void F959_8325 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 958, Current, 0, 8324);
	RTSA(dtype);
	RTME(dtype, 0);
