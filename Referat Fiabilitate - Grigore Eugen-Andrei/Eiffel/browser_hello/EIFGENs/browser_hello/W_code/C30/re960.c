...
extern EIF_TYPED_VALUE F960_4424(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_4425(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_4426(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_4427(EIF_REFERENCE);
extern void F960_4428(EIF_REFERENCE);
extern void F960_8314(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F960_4424 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F960_4425 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F960_4426 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 5501);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(959, Current, 5501);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F960_4427 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 5502);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(959, Current, 5502);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F960_4428 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 5503);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(959, Current, 5503);
	RTIV(Current, RTAL);
...
void F960_8314 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 959, Current, 0, 8313);
	RTSA(dtype);
	RTME(dtype, 0);
