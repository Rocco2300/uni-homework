...
extern EIF_TYPED_VALUE F961_4422(EIF_REFERENCE);
extern void F961_8313(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F961_4422 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 5431);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(960, Current, 5431);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F961_8313 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 960, Current, 0, 8312);
	RTSA(dtype);
	RTME(dtype, 0);
