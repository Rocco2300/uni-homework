...
extern void F615_8312(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F615_4420 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 614, Current, 0, 0, 5395);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(614, Current, 5395);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F615_8312 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 614, Current, 0, 8311);
	RTSA(dtype);
	RTME(dtype, 0);
