...
extern EIF_TYPED_VALUE F619_4380(EIF_REFERENCE);
extern void F619_8310(EIF_REFERENCE, int);
...
/* {ACTIVE}.replaceable */
EIF_TYPED_VALUE F619_4380 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 618, Current, 0, 0, 5339);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(618, Current, 5339);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {ACTIVE}._invariant */
void F619_8310 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 618, Current, 0, 8309);
	RTSA(dtype);
	RTME(dtype, 0);
