...
extern EIF_TYPED_VALUE F605_4858(EIF_REFERENCE);
extern EIF_TYPED_VALUE F605_4861(EIF_REFERENCE);
extern void F605_8320(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F605_4858 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 604, Current, 0, 0, 6007);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(604, Current, 6007);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F605_4861 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 604, Current, 0, 0, 6008);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(604, Current, 6008);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F605_8320 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 604, Current, 0, 8319);
	RTSA(dtype);
	RTME(dtype, 0);
