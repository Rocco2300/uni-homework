...
extern EIF_TYPED_VALUE F607_4137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F607_4137 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 606, Current, 0, 0, 4105);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(606, Current, 4105);
	RTIV(Current, RTAL);
